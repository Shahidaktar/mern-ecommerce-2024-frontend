      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="flex flex-col items-center lg:absolute lg:top-[29%]">
            ...
            <img
              src={photoUpdate ? photoUpdate : photo}
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
              ...
              >
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full rounded-md bg-red-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600"
                  >
                    Update
                  </button>
                </div>
